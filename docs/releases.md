...
| Node restart support                                                                                   | 1.33.1-gke.1959000 or later.                                                                | v2.12.2+         |
| Support for mounting the same {{storage_name}} bucket to the same Pod using different PersistentVolumes   | 1.33.0-gke.1932000 or later.                                                                | v2.12.2+         |
