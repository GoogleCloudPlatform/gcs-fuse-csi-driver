...
| [Cloud Storage FUSE metrics](https://cloud.google.com/kubernetes-engine/docs/how-to/cloud-storage-fuse-csi-driver-perf#cloud-storage-fuse-metrics) | 1.31.1-gke.1621000 or later, enabled by default on 1.33.0-gke.2248000 or later.              | v2.5.0+      |
...
| [Cloud Storage FUSE performance defaults](https://docs.cloud.google.com/kubernetes-engine/docs/how-to/cloud-storage-fuse-csi-driver-perf#defaults-for-high-performance-machine-types)       | 1.33.2-gke.4655000 or later.                                                                | v3.1.0+         |
