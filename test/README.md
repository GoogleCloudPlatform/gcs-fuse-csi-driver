...
- `REGISTRY`: Change the container registry to your own if you need to build your own CSI images. Make sure you have permission to push images to the container registry. An example value might be `us-docker.pkg.dev/$your-registry-name/$your-registry-folder`.
