...
wget https://github.com/protocolbuffers/protobuf-go/releases/download/$PROTOC_GEN_GO_VERSION/protoc-gen-go.$PROTOC_GEN_GO_VERSION.linux.amd64.tar.gz
...
rm -f protoc-$PROTOCOL_BUF_VERSION-linux-x86_64.zip
rm -f protoc-gen-go-grpc.$PROTOC_GEN_GO_GRPC_VERSION.linux.amd64.tar.gz
rm -f protoc-gen-go.$PROTOC_GEN_GO_VERSION.linux.amd64.tar.gz
sudo chmod +x /usr/local/bin/protoc-gen-go
sudo chmod +x /usr/local/bin/protoc-gen-go-grpc
sudo chmod 777 /usr/local/bin/protoc-gen-go
sudo chmod 777 /usr/local/bin/protoc-gen-go-grpc