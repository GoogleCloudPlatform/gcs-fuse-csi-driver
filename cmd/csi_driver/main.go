...
var (
	...
	leaderElectionNamespace     = flag.String("leader-election-namespace", "gcs-fuse-csi-driver", "The namespace where the leader election resource exists. Defaults to 'gcs-fuse-csi-driver'.")
...
func main() {
	...
	// Setup signal handling for graceful shutdown. Currently,
	// only the bucket scanner controller uses this context.
