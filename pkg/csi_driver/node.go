...
func (s *nodeServer) NodePublishVolume(ctx context.Context, req *csi.NodePublishVolumeRequest) (*csi.NodePublishVolumeResponse, error) {
	...
	if args.enableCloudProfilerForSidecar && gcsFuseSidecarImage != "" && isSidecarVersionSupportedForGivenFeature(gcsFuseSidecarImage, SidecarCloudProfilerMinVersion) {
	...
	if err := s.setupMultiNIC(&args); err != nil {
		return nil, err
	}
...
func (s *nodeServer) setupMultiNIC(args *requestArgs) error {
	// TODO: add events for choice of node or lack thereof.
