...
func newControllerServer(driver *GCSDriver, storageServiceManager storage.ServiceManager, featureOptions *GCFSDriverFeatureOptions) (csi.ControllerServer, error) {
	cs := &controllerServer{
		driver:                driver,
